...
function PodDisplayCard({ pod, componentData, onDeletePodHandler, setPodDataUpdateTrigger }) {
  ...
  return (
    <article className="border-2 p-2 rounded-md drop-shadow-2xl">
      <section className="w-min-sm">
        ...
        <p>
          <span className="font-bold">Reseller price: </span> £{pod.resellerPrice}
        </p>
        <p>
          <span className="font-bold">Retail price: </span> £{pod.retailPrice}
        </p>
        <p>
